	...
	return (
		<Layout pageName="Privacy Policy">
			<div className="text-content">
				...
				<p>
					Articles on this site may incude embedded content (e.g.
				...
				<p>
					We do not share your data with anyone outside of the company
					and direct affiliates for the sole purposes of servicing you
					as a customer of Ambient Studios without your express
					consent. Internal use only. Period.
				</p>
				...
				<p>
					If you have any questions or concerns at any time, feel free
					to reach us via info@ambientstudios.com.
				</p>
			</div>
		</Layout>
	);
